...
> [!IMPORTANT]
> **1.0'dan mı geliyorsun? Bu sürümü bir kez elle kur.** AndroMac'in uygulama kimliği değişti,
> artık `io.github.anilmetin0.andromac`. Eskisi olan `dev.andromac`, projenin hiç sahip olmadığı
> bir alan adına dayanıyordu. Android ve 1.0'ın güncelleyicisi için 1.1 başka bir uygulama.
>
