...
object UpdateCheck {
    ...
    data class Release(
        ...
        /** The Android build of this release, `AndroMac-<version>-android.apk`. One APK for every ABI: there is no native code. */
    ...
    fun parse(json: String): Release? {
        ...
        return Release(version, commitOf(o.optString("target_commitish")) ?: COMMIT.find(name)?.groupValues?.get(1), url, assets(o))
    }
