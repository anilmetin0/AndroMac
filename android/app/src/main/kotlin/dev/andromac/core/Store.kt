...
class Store(context: Context) {
     ...
     * one request to api.github.com when the app is opened, at most once a day
     * (feature/UpdateCheck.kt). Keeping it off keeps the "nothing leaves your devices" promise literal.
     */
    var updateCheck: Boolean
        get() = prefs.getBoolean(K_UPDATE_CHECK, false)
