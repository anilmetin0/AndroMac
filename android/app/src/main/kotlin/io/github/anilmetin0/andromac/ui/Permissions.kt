...
enum class Permission(val titleRes: Int, val noteRes: Int, val kind: Kind) {
    ...
    NOTIFICATION_ACCESS(R.string.setup_notif_title, R.string.setup_notif_note, Kind.REQUIRED) {
        /**
         * A substring match is NOT enough: the release package is `io.github.anilmetin0.andromac` and the debug
         * package is `io.github.anilmetin0.andromac.debug`. With only the debug variant enabled, release used to
