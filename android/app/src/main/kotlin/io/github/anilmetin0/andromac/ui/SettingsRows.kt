...
fun io.github.anilmetin0.andromac.core.Store.appFilterSummary(activity: Activity): String {
    val total = seenApps.size
    val limited = appModes.count { it.value != io.github.anilmetin0.andromac.core.Store.MODE_FULL }
    return when {
