...
kotlin {
    ...
    sourceSets["main"].kotlin.include(
        "io/github/anilmetin0/andromac/vectors/**",
        "io/github/anilmetin0/andromac/core/Crypto.kt",
        // For the handshake test. These three files deliberately use no Android API.
        "io/github/anilmetin0/andromac/core/Session.kt",
        "io/github/anilmetin0/andromac/core/Protocol.kt",
...
application { mainClass.set("io.github.anilmetin0.andromac.vectors.MainKt") }
