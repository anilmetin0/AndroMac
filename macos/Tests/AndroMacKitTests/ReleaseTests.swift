...
struct ReleaseTests {
    ...
    @Test func parsesTheAssetsTheUpdaterNeeds() throws {
        ...
        "html_url":"https://github.com/anilmetin0/AndroMac/releases/tag/v1.0.0",\
        "assets":[\
        {"name":"AndroMac-1.0.0-fd7d47a-macOS.zip","size":1234,\
         "browser_download_url":"https://github.com/anilmetin0/AndroMac/releases/download/v1.0.0/AndroMac-1.0.0-fd7d47a-macOS.zip"},\
        {"name":"AndroMac-1.0.0-fd7d47a.apk","size":99,\
         "browser_download_url":"https://github.com/anilmetin0/AndroMac/releases/download/v1.0.0/AndroMac-1.0.0-fd7d47a.apk"},\
        ...
        #expect(r.macZip?.name == "AndroMac-1.0.0-fd7d47a-macOS.zip")
        #expect(r.macZip?.size == 1234)
    ...
    @Test func assetsFromElsewhereAreDropped() throws {
        ...
        "html_url":"https://github.com/anilmetin0/AndroMac/releases/tag/v1.0.0",\
        "assets":[\
        {"name":"AndroMac-1.0.0-macOS.zip",\
         "browser_download_url":"https://example.com/AndroMac-1.0.0-macOS.zip"},\
        {"name":"../escape-macOS.zip",\
         "browser_download_url":"https://github.com/anilmetin0/AndroMac/releases/download/v1.0.0/x.zip"}]}
        """.utf8)
        let r = try #require(Release.parse(json))
